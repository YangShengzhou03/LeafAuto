...
"}")
    ...
    def retranslateUi(self, SettingWindow):
        ...
        self.label_5.setText(_translate("SettingWindow", "全局使用网络授时（会员专享）"))
        self.label_6.setText(_translate("SettingWindow", "启动时自动检查更新"))
        self.label_7.setText(_translate("SettingWindow", "信息出错时发送邮件提醒"))
        self.label_setting_2.setText(_translate("SettingWindow", "高级设置"))
        self.label_language.setText(_translate("SettingWindow", "PC客户端微信语言"))
