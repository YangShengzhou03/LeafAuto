...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_addtime.setText(_translate("MainWindow", "添加任务自增分钟"))
        self.label_errorAudio.setText(_translate("MainWindow", "任务出错时提示音"))
        self.comboBox_errorAudio.setItemText(0, _translate("MainWindow", "提示音1"))
        self.comboBox_errorAudio.setItemText(1, _translate("MainWindow", "提示音2"))
        self.comboBox_errorAudio.setItemText(2, _translate("MainWindow", "提示音3"))
        self.comboBox_errorAudio.setItemText(3, _translate("MainWindow", "提示音4"))
        self.comboBox_errorAudio.setItemText(4, _translate("MainWindow", "提示音5"))
        ...
        self.label_copy_right.setText(_translate("MainWindow", "LeafAuto © 2025 Yangshengzhou All Rights Reserved"))
